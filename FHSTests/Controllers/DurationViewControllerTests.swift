...
class DurationViewControllerTests: XCTestCase {
    ...
    override func setUp() {
        ...
        controller = storyboard.instantiateViewController(withIdentifier: "DurationViewController") as! DurationViewController
    ...
    func testWithRestTimer() {
        ...
        let expectation = self.expectation(description: "Testing timer2...")
